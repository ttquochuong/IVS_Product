...
namespace BL.Product
{
    public class CategoryBL
    {
        ...
        public int SearchList(out List<CategoryDTO> dtResult)
        {
            int returnCode = CategoryDAO.SearchList(out dtResult);
            return returnCode;
        }

        public int SearchListUp(CategoryDTO dto, out List<CategoryDTO> dtResult)
        {
            int returnCode = CategoryDAO.SearchListUp(dto, out dtResult);
            return returnCode;
        }
    }
}
